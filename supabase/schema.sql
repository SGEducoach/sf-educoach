...
-- ============ SeFu Oto Program (0109) ============
-- Öğrencinin onayladığı program ayarları taşıma için saklanır; üretilen
-- görevler ait oldukları oto programla ilişkilendirilir.
...
-- ============ Deneme karne özeti (migration 0123) ============
