          ...
          {seciliDers ? (
            dersTrendChartData.length === 0 ? <BosDurum /> : (
              <ResponsiveContainer width="100%" height={200}>
                <LineChart data={dersTrendChartData} margin={{ left: -20, right: 10 }}>
                  ...
                  <XAxis dataKey="gun" tick={{ fontSize: 11, fill: TEXT_MUTED }} axisLine={{ stroke: BORDER }} tickLine={false} />
                  <YAxis tick={{ fontSize: 11, fill: TEXT_MUTED }} axisLine={false} tickLine={false} />
                  <RTooltip cursor={false} reverseDirection={{ x: true }} wrapperStyle={{ zIndex: 30 }} contentStyle={{ fontSize: 12, borderRadius: 12, border: `2px solid ${BORDER_STRONG}`, background: BG1_ALT }} labelStyle={{ color: TEXT_MUTED }} itemStyle={{ color: TEXT }} formatter={(deger) => [deger, seciliDers]} />
            ...
            <ResponsiveContainer width="100%" height={200}>
              <BarChart data={veri.dersNetOrtalama} margin={{ left: -20, right: 10 }}>
                ...
                <YAxis tick={{ fontSize: 11, fill: TEXT_MUTED }} axisLine={false} tickLine={false} />
                <RTooltip shared={false} cursor={false} reverseDirection={{ x: true }} wrapperStyle={{ zIndex: 30 }} contentStyle={{ fontSize: 12, borderRadius: 12, border: `2px solid ${BORDER_STRONG}`, background: BG1_ALT }} labelStyle={{ color: TEXT_MUTED }} itemStyle={{ color: TEXT }} />
