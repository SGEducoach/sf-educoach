...
export default async function YoneticiRozetlerPage({ searchParams }: {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main id="ana-icerik" className="mx-auto flex w-full max-w-[100rem] flex-1 flex-col gap-5 px-4 py-7 pb-24 sm:px-6 lg:pb-7">
        <YonetimNavigasyonu tur="yonetici" aktif="rozetler" />
